...
class StocksInfo extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['record_id'], 'exist', 'skipOnError' => true, 'targetClass' => Stocks::className(), 'targetAttribute' => ['record_id' => 'id']],
        ];
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\queries\StocksInfo the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\queries\StocksInfo(get_called_class());
    }
}
