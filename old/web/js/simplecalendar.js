var calendar = {
	...
	init: function(ajax) {
		...
		function GetMonthName(monthNumber) {
			var months = ['января', 'февраля', 'маря', 'апреля', 'мая', 'июня', 'июля', 'авгуся', 'сентября', 'октября', 'ноября', 'декабря'];
          ...
          for (var i = 0; i < events.length; i++) {
            $('.b-shedule').append(
            	...
            	+'" data-number="'+ i +'">'
	              ...
	              + events[i].year  + ' года'
	              +'</div>'
	              +'<h2 class="b-event__title"><span>Тема: </span>«'+events[i].title+'»</h2>'
	              ...
	              +'<div class="b-event__action">'
	              	+'<a href="'+events[i].link+'" class="btn btn--inline btn--colored">Зарегистрироваться</a>'
	              +'</div>');
          }
