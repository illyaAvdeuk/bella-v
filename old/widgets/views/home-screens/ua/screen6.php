                ...
                <div class="screen__promo promo">
                                ...
                                <div class="promo__block promo__block-1">
                                        <div class="promo__list list">
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">
                                                                <div class="item__text">
                                                                        Міжнародна компанія з офісами у Києві, Москві, Нью Йорку
                                                ...
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">
                                                                <div class="item__text">
                                                                        Реалізували проекти в Україні, СНД, Європі
                                                                        <div data-anijs="if: scroll, on: window, do: slideInRight animated, before: scrollReveal, after: holdAnimClass" class="item__underline is-animated"></div>
                                                                </div>
                                                        </div>
                                                </div>
                                ...
                                <div class="promo__block promo__block-2">
                                        <div class="promo__list list">
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">
                                                                <div class="item__text">
                                                                        Представляємо кращі світові бренди
                                                                        <div data-anijs="if: scroll, on: window, do: slideInRight animated, before: scrollReveal, after: holdAnimClass" class="item__underline is-animated"></div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">
                                                                <div class="item__text">
                                                                        Пропонуємо рішення для бізнесу будь-якого розміру
                                                                        <div data-anijs="if: scroll, on: window, do: slideInRight animated, before: scrollReveal, after: holdAnimClass" class="item__underline is-animated"></div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">
                                                                <div class="item__text">
                                                                        Пропонуємо зручні форми оплати, включно розстрочку та лізинг
                                                                        <div data-anijs="if: scroll, on: window, do: slideInRight animated, before: scrollReveal, after: holdAnimClass" class="item__underline is-animated"></div>
                                                                </div>
                                                        </div>
                                                </div>
                        ...
                        <div class="grid">
                                ...
                                <div class="promo__block promo__block-4">
                                        <div class="promo__list list">
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="item__inner item__inner-1 is-animated">
                                                                <div class="item__text">
                                                                        <strong class="qty js-qty-clients">1596</strong>
                                                ...
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="item__inner item__inner-2 is-animated">
                                                                <div class="item__text">
                                                                        <strong class="qty js-qty-projects">958</strong>
                                                ...
                                                <div class="list__item item">
                                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="item__inner item__inner-3 is-animated">
                                                                <div class="item__text">
                                                                        <strong class="qty js-qty-employee">328</strong>
                                                                        Співробітників у штаті
                                                                        <div data-anijs="if: scroll, on: window, do: slideInRight animated, before: scrollReveal, after: holdAnimClass" class="item__underline is-animated"></div>
                                                                </div>
                                                        </div>
                                                </div>
