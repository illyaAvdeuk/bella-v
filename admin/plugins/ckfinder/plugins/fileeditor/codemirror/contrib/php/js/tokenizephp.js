  ...
  */
  var keywords = function(){
    ...
    [ "zend_version", "func_num_args", "func_get_arg", "func_get_args", "strlen",
      ...
      "mysql_pconnect", "mysql_close", "mysql_select_db", "mQuery",
      "mysql_unbuffered_query", "mysql_db_query", "mysql_list_dbs",
      "mysql_list_tables", "mysql_list_fields", "mysql_list_processes",
      "mError", "mysql_errno", "mysql_affected_rows", "mysql_insert_id",
      "mysql_result", "mNumRows", "mysql_num_fields", "mFetchRow",
      "mFetchArray", "mFetchAssoc", "mysql_fetch_object",
